      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar z-index-40">
          ...
          <ul class="list-unstyled py-4">
            ...
            <li class="sidebar-item active"><a class="sidebar-link" href="/admincorreos"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
            ...
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 py-3">
                  ...
                  <li class="breadcrumb-item active fw-light" aria-current="page">Correos</li>
                </ol>
              </nav>
            </div>
          </div>
		...
		<div class="page">
            ...
            @foreach($Correos as $Correo)
                ...
                <form action="" method="POST">
                  @csrf
                  @method('DELETE')
                  <button type="submit" onclick="return confirm('¿Desea eliminar?')" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                </form>
							</td>
						</tr>
            @endforeach
