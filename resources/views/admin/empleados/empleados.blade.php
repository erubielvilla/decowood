      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar z-index-40">
          ...
          <ul class="list-unstyled py-4">
            <li class="sidebar-item"><a class="sidebar-link" href="/admintablero"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                  <use xlink:href="#real-estate-1"> </use>
                </svg>Inicio </a></li>
            <li class="sidebar-item active"><a class="sidebar-link" href="/adminempleados"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
        ...
        <div class="content-inner w-100">
          ...
          <header class="bg-white shadow-sm px-4 py-3 z-index-20">
            <div class="container-fluid px-0">
              <h2 class="mb-0 p-1">Empleados</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          <div class="bg-white">
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 py-3">
                  ...
                  <li class="breadcrumb-item active fw-light" aria-current="page">Empleados</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <h1>Empleados<a href="{{ route('adminempleados.create') }}" class="btn btn-success">Agregar</a></h1>
        <form class="d-flex">
		...
		<div class="page">
            ...
            @foreach($Empleados as $Empleado)
              ...
              <td>
               <a href="{{route('adminempleados.edit', $Empleado->id)}}" class="btn btn-warning"><i class=" fa fa-pencil-square"></i></a>
							</td>
							<td>
                <form action="{{ route('adminempleados.destroy', $Empleado->id) }}" method="POST">
                  @csrf
                  @method('DELETE')
