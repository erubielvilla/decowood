      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar z-index-40">
          ...
          <ul class="list-unstyled py-4">
            ...
            <li class="sidebar-item active"><a class="sidebar-link" href="/adminpedidos"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
        ...
        <h1>Pedidos<a href="{{route('adminpedidos.create')}}" class="btn btn-success">Agregar</a></h1>
        <form class="d-flex">
		...
		<div class="page">
            ...
            @foreach($Pedidos as $Pedido)
              ...
              <td>
               <a href="{{route('adminpedidos.edit', $Pedido->id)}}" class="btn btn-warning"><i class=" fa fa-pencil-square"></i></a>
              </td>
              <td>
                <form action="{{route('adminpedidos.destroy', $Pedido->id)}}" method="POST">
                  @csrf
                  @method('DELETE')
