      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar z-index-40">
          ...
          <ul class="list-unstyled py-4">
            ...
            <li class="sidebar-item active"><a class="sidebar-link" href="/adminmuebles"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                  <use xlink:href="#real-estate-1"></use>
                </svg>Muebles </a></li>
        ...
        <h1>Muebles<a href="{{route('adminmuebles.create')}}" class="btn btn-success">Agregar</a></h1>
        <form class="d-flex">
		...
		<div class="page">
            ...
            @foreach($Muebles as $Mueble)
              ...
              <td>
                <a href="{{route('adminmuebles.edit', $Mueble->id)}}" class="btn btn-warning"><i class=" fa fa-pencil-square"></i></a>
							</td>
							<td>
                <form action="{{route('adminmuebles.destroy', $Mueble->id)}}" method="post">
                  @csrf
                  @method('DELETE')
