      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar z-index-40">
          ...
          <ul class="list-unstyled py-4">
            <li class="sidebar-item active"><a class="sidebar-link" href="/cartablero"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                  <use xlink:href="#real-estate-1"> </use>
                </svg>Inicio </a></li>
            <li class="sidebar-item"><a class="sidebar-link" href="/carpedidos"> 
                <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
                  ...
                  <div class="row gx-5 bg-white">
                    ...
                    <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <a href="/carpedidos"><h6 class="h4 fw-light text-gray-600 mb-3">PEDIDOS</h6></a>
