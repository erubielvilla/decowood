...
<div class="container text-center">
	<h1>PEDIDOS<small>[Agregar pedido]</small></h1>
		<div class="row">
			<div class="col-md-8">
				<div class="page">
					<form method="POST" action="{{route('cappedidos.store')}}">
						@csrf
						...
						<div class="form-group">
							...
							<input type="text" name="mueble" class="form-control" placeholder="" required>
						</div>
						<div class="form-group">
							<label for="direccion">Dirección</label>
							<input type="text" name="direccion" class="form-control" placeholder="calle tijia" required>
						</div>
                        <div class="form-group">
