      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar z-index-40">
          ...
          <ul class="list-unstyled py-4">
            <li class="sidebar-item active"><a class="sidebar-link" href="/captablero"> 
                  ...
                  <div class="row gx-5 bg-white">
                    ...
                    <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <a href="/capempleados"><h6 class="h4 fw-light text-gray-600 mb-3">Empleados</h6></a>
                    ...
                    <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <a href="/cappedidos"><h6 class="h4 fw-light text-gray-600 mb-3">Pedidos</h6></a>
                          <div class="progress" style="height: 4px">
                    ...
                    <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <a href="capmuebles"><h6 class="h4 fw-light text-gray-600 mb-3">Muebles</h6></a>
                          <div class="progress" style="height: 4px">
                    ...
                    <div class="col-xl-3 col-sm-6 py-4">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <a href="/capcorreos"><h6 class="h4 fw-light text-gray-600 mb-3">Correros</h6></a>
                          <div class="progress" style="height: 4px">
                    ...
                    <div class="col-xl-3 col-sm-6 py-4">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="mx-3">
                          <a href="/capclientes"><h6 class="h4 fw-light text-gray-600 mb-3">Cliente</h6></a>
                          <div class="progress" style="height: 4px">
                            <div class="progress-bar bg-orange" role="progressbar" style="width: 50%; height: 4px;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
