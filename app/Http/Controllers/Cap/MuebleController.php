...
class MuebleController extends Controller
{
    ...
    public function index()
    {
        //
        $Muebles=Mueble::all();
        return view('capturista.muebles.index', compact('Muebles'));
    }
    ...
    {
        return view('capturista.muebles.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('capmuebles.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('capturista.muebles.edit', compact('Mueble'));
    }
